  ...
  return (
    <div className="max-w-2xl mx-auto p-4 sm:p-6 md:p-8 space-y-6">
      <div className="flex flex-row items-center justify-between mb-6">
        ...
        {isTareaCompleta ? <p className="text-lg text-green-700 text-start max-w-max font-medium bg-green-200 py-2 px-4 rounded-lg">Conciliada</p> : ""}
      </div>
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              id="totalPagado"
              value={totalPagado}
              onChange={(e) => handleInputChange('totalPagado', e.target.value)}
        ...
        <div className="flex flex-col space-y-4">
          <Link href="/mis-facturas" passHref>
            <Button 
              variant="primary" 
              className={`text-center ${isTareaCompleta ? 'bg-green-600 hover:bg-green-700' : ''}`}
            >
              Volver a la lista
            </Button>
          </Link>
